...
Console.WriteLine($"Implicit type conversion: {c + a}");
Console.WriteLine($"Implicit type conversion: {(char)(c + a)}");
Console.WriteLine($"Implicit type conversion: {f + a + c}");
...
void StructOp(TheStruct theStruct)
{
